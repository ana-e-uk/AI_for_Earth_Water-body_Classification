#!/bin/bash -l
#SBATCH -o /users/5/aghaa001/AI_for_Earth_Water-body_Classification/out/out.output
#SBATCH -e /users/5/aghaa001/AI_for_Earth_Water-body_Classification/out/out.error    
...
#SBATCH --mail-user=aghaa001@umn.edu 
